...
export default function TirePressureHistoryScreen({ route }: Props) {
  ...
  const renderHeader = () => (
    <View style={[styles.row, styles.headerRow]}>
      ...
      <Text style={[styles.cell, styles.headerCell]}>FL</Text>
      <Text style={[styles.cell, styles.headerCell]}>FR</Text>
      <Text style={[styles.cell, styles.headerCell]}>RL</Text>
      <Text style={[styles.cell, styles.headerCell]}>RR</Text>
    </View>
  );
