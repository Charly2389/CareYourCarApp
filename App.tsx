    ...
    <SafeAreaProvider>
      <NavigationContainer>
        ...
        >
          ...
          />
          <Stack.Screen name="AddMaintenance" component={AddEditMaintenanceScreen} options={{ title: 'A帽adir mantenimiento' }} />
          ...
          <Stack.Screen name="TirePressureHistory" component={TirePressureHistoryScreen} options={{ title: 'Hist贸rico de presiones' }} />
